		...
		for (int x = 0; x < nScreenWidth; x++)
		{
			...
			for (int y = 0; y < nScreenHeight; y++)
			{
				...
				else
				{
					...
					// NOTE OF FIX/ERROR
					// ERROR: Could not render wall and floor at same time. Floor was the only one visiable.
					// PROBLEM: Floor and wall shared the same variable. And rendered floor since it rendered last.
					// FIX: Separate floor and wall shade into two variables.
